  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        <TouchableOpacity onPress={() => { router.push('/admin/users') }} style={styles.inactiveTab}>
          <Text style={styles.inactiveTabText}>Участники</Text>
        </TouchableOpacity> 
        <TouchableOpacity  style={styles.activeTab}>
          <Text style={styles.activeTabText}>Завявки</Text>
        </TouchableOpacity>
      </View>
