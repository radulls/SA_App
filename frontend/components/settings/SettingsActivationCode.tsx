...
interface SettingsActivationCodeProps {
  ...
  onBack: () => void;
  setActiveSetting: (setting: string | null) => void;
}
...
const SettingsActivationCode: React.FC<SettingsActivationCodeProps> = ({ userRole, onBack, setActiveSetting }) => {
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.formWrapper}>
          ...
          {(userRole === 'creator' || userRole === 'admin') && (
            <TouchableOpacity style={[styles.showSurnameContainer, { paddingTop: 40 }]} onPress={() => setActiveSetting('addedUsers')}>
