...
Class<RCTComponentViewProtocol> SkiaDomViewCls(void) __attribute__((used)); // 1
Class<RCTComponentViewProtocol> SkiaPictureViewCls(void) __attribute__((used)); // 1
#endif
...
Class<RCTComponentViewProtocol> RNSVGFeCompositeCls(void) __attribute__((used)); // 6
