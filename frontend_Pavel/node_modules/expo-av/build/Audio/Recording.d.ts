...
import { RecordingInput, RecordingObject, RecordingOptions, RecordingStatus } from 'expo-av/src/Audio/Recording.types';
...
export * from 'expo-av/src/Audio/RecordingConstants';
export * from 'expo-av/src/Audio/Recording.types';
