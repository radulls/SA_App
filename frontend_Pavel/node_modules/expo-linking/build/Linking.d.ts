...
import { ParsedURL, SendIntentExtras, URLListener } from 'expo-linking/src/Linking.types';
/**
...
export * from 'expo-linking/src/Linking.types';
export * from 'expo-linking/src/Schemes';
export { parse, createURL } from 'expo-linking/src/createURL';
