...
export declare namespace StorageAccessFramework {
     ...
     */
    const writeAsStringAsync: typeof import("expo-file-system/src/FileSystem").writeAsStringAsync;
    /**
     * Alias for [`readAsStringAsync`](#filesystemreadasstringasyncfileuri-options) method.
     */
    const readAsStringAsync: typeof import("expo-file-system/src/FileSystem").readAsStringAsync;
    /**
     * Alias for [`deleteAsync`](#filesystemdeleteasyncfileuri-options) method.
     */
    const deleteAsync: typeof import("expo-file-system/src/FileSystem").deleteAsync;
    /**
     * Alias for [`moveAsync`](#filesystemmoveasyncoptions) method.
     */
    const moveAsync: typeof import("expo-file-system/src/FileSystem").moveAsync;
    /**
     * Alias for [`copyAsync`](#filesystemcopyasyncoptions) method.
     */
    const copyAsync: typeof import("expo-file-system/src/FileSystem").copyAsync;
}
